                ...
                <div id="wrapper">
                    <div id="login" class="animate form">
                        <form action="index.jsp" method="post" autocomplete="on"> 
                            ...
                            <%}%>
                            <h3> Ride , <%=request.getParameter("rideId")%> has been successfully scheduled. Check the status <a href="safeRideHomeController?requestFrom=rideStatus&rideId=<%=request.getParameter("rideId")%>"> here</a>.</h3>
                        </form>
                    </div>
                </div>
            </div>
