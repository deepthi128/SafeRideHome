...
<head>
    ...
    <title>Safe Ride Home - Student Home</title>
            ...
            <div class="hero">
                <div id="wrapper">
                    <div id="login" class="animate form">
                        <form action="index.jsp" method="post" autocomplete="on">  <center>
                                <h1>
                                    Student Home
                                </h1>   
                                ...
                                <p >
                                    <a href="safeRideHomeController?requestFrom=requestRide"> Request a Ride</a>
                                </p>
                                <br/>
                                <br/>
                                <p >
                                    <a href="safeRideHomeController?requestFrom=rideStatus" > Check Ride Status</a>
                                </p> 
                                <br/>
                                <br/>
                                <p >
