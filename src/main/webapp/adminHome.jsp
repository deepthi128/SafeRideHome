...
<head>
    ...
    <title>Safe Ride Home - Admin Home</title>
                        ...
                        <div id="wrapper">
                            <div id="login" class="animate form">
                                ...
                                <h4><font color="blue" family="Lucida Console" >
                                    <p >
                                        <a href="generateReport.jsp" >Statistics</a>
                                    </p>
                                   <br/>
                                    <p >
                                    ...
                                    <br/>
                                    <p >
                                        <a href="safeRideHomeController?requestFrom=adminManageUsers" >Manage Users</a>
                                    </p>
                                    <br/>
                                    <p >
                                        <a href="adminAddVehicle.jsp" >Add Vehicle</a>
                                    </p>
                                    <br/>
                                    <p >
                                    ...
                                    <br/>
                                    <p >
                                        <a href="safeRideHomeController?requestFrom=releaseVehicles" >Release Vehicles</a>
                                    </p>
                                    <br/>
                                    <p >
