 ...
 */
package edu.nwmissouri.universitypolice.saferidehome.util;
...
public class SafeRideHomeUtil {
    ...
    private boolean sendConfirmationMail(User user) {
        String msg = "<html>	 <body>	 <center>		<img src='/images/safeRideLogo.jpg' width='80' height='80' border='0' >		</center>	Welcome " + user.getName() + ", <br/> <br/>	Your registration with Safe Ride Home is almost complete. Please click on the following link to verify your account. <br/> <br/>	<center><a href='http://localhost:8080/SafeRideHome/safeRideHomeController?requestFrom=verifyUser&key=asdjkhasw392NCWEUHF834HEUIH348R32892U3EMQX21SDALKJ34k2j34h234n2jk3n42uh323ui2uh32g42y3u4y2h342h4239reh9324rfwhe239478h&userId=" + user.getUserId() + "'> Click here to confirm your account</a> </center>	<br/>	</br>	Have a Safe Ride Home!!!	<br/> <br/>	- Team SafeRideHome.	<br/> <br/> <br/> <br/>	Follow us on Facebook at https://www.facebook.com/safe.rides.9 for any changes in Safe Ride timings and updates.	</br></br>	This is an automatic mail. Please do not respond to this message. For further queries, contact us at (660) 562-1245. 		</body>	</html>	";  
        return sendEmail(user.getEmailId(),"SafeRideHome Email Verification", msg);
    }

    
    
    private boolean sendEmail(String toAddress, String subject, String msg) {
        Session session;
        Properties props;
        try {
            ...
            session = Session.getInstance(props,
                    new javax.mail.Authenticator() {
                        ...
                        protected PasswordAuthentication getPasswordAuthentication() {
                            return new PasswordAuthentication("nwmsusaferidehome@gmail.com", "universitypolice");
                        }
                    });
    ...
    public String sendResetPasswordEmail(String userId, String phoneNumber, String emailId) {
        SafeRideHomeDao dao = new SafeRideHomeDao();
        String msg = "<html>	 <body>	 <center>		<img src='/images/safeRideLogo.jpg' width='80' height='80' border='0' >		</center>	Welcome back,  <br/> <br/>	To reset your password, click on the link below <br/> <br/>	<center><a href='http://localhost:8080/SafeRideHome/safeRideHomeController?requestFrom=resetPassword&key=asdjkhasw392NCWEUHF834HEUIH348R32892U3EMQX21SDALKJ34k2j34h234n2jk3n42uh323ui2uh32g42y3u4y2h342h4239reh9324rfwhe239478h&userId=" + userId + "'> Click here to reset your password</a> </center>	<br/>	</br>	Have a Safe Ride Home!!!	<br/> <br/>	- Team SafeRideHome.	<br/> <br/> <br/> <br/>	Follow us on Facebook at https://www.facebook.com/safe.rides.9 for any changes in Safe Ride timings and updates.	</br></br>	This is an automatic mail. Please do not respond to this message. For further queries, contact us at (660) 562-1245. 		</body>	</html>	";
        if (dao.validateUserDetailsForPasswordReset(userId, phoneNumber, emailId)) {            
